...
const en = {
	...
	obsGuide: 'Use these settings in OBS.', obsServer: 'Server', obsStreamKey: 'Stream key', resync: 'Resync', play: 'Play', pause: 'Pause', mute: 'Mute', unmute: 'Unmute',
	...
	publicDescription: 'Anyone with the viewing URL can watch. Superneko users can read and post chat messages.', noFollowingStreams: 'No followed users are Howling.',
...
const ja = {
	...
	obsGuide: 'OBSでは設定は以下のように設定します。', obsServer: 'サーバー', obsStreamKey: 'ストリームキー', resync: 'Resync', play: '再生', pause: '一時停止', mute: 'ミュート', unmute: 'ミュート解除',
	...
	publicDescription: '視聴用URLを知っている人が視聴できます。すーぱーねこのユーザーはチャットを閲覧・投稿できます。', noFollowingStreams: 'フォロー中のHowlはありません。',
