...
import { CheckExpiredHowlsProcessorService } from './processors/CheckExpiredHowlsProcessorService.js';
...
export class QueueProcessorService implements OnApplicationShutdown {
	...
	constructor(
		...
		private checkExpiredHowlsProcessorService: CheckExpiredHowlsProcessorService,
		...
		//#region system
		{
			const processer = (job: Bull.Job) => {
				switch (job.name) {
					...
					case 'checkExpiredHowls': return this.checkExpiredHowlsProcessorService.process();
