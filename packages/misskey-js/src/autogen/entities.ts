...
export type AdminLiveStreamsEndRequest = operations['admin___live-streams___end']['requestBody']['content']['application/json'];
...
export type LiveStreamChatDeleteRequest = operations['live-stream___chat-delete']['requestBody']['content']['application/json'];
export type LiveStreamChatMessagesRequest = operations['live-stream___chat-messages']['requestBody']['content']['application/json'];
export type LiveStreamChatMessagesResponse = operations['live-stream___chat-messages']['responses']['200']['content']['application/json'];
export type LiveStreamChatSendRequest = operations['live-stream___chat-send']['requestBody']['content']['application/json'];
export type LiveStreamChatSendResponse = operations['live-stream___chat-send']['responses']['200']['content']['application/json'];
export type LiveStreamCreateRequest = operations['live-stream___create']['requestBody']['content']['application/json'];
export type LiveStreamCreateResponse = operations['live-stream___create']['responses']['200']['content']['application/json'];
export type LiveStreamFinishRequest = operations['live-stream___finish']['requestBody']['content']['application/json'];
export type LiveStreamFollowingResponse = operations['live-stream___following']['responses']['200']['content']['application/json'];
export type LiveStreamGuestJoinRequest = operations['live-stream___guest-join']['requestBody']['content']['application/json'];
export type LiveStreamGuestJoinResponse = operations['live-stream___guest-join']['responses']['200']['content']['application/json'];
export type LiveStreamJoinRequest = operations['live-stream___join']['requestBody']['content']['application/json'];
export type LiveStreamJoinResponse = operations['live-stream___join']['responses']['200']['content']['application/json'];
export type LiveStreamShowRequest = operations['live-stream___show']['requestBody']['content']['application/json'];
export type LiveStreamShowResponse = operations['live-stream___show']['responses']['200']['content']['application/json'];
